	...
	<footer>
		<div class="wrapper footer">
			<ul>
				...
				<li class="about">
					<p>JK Rescue team is an organized company that rents cars and other vehicles to clients at lower costs. We we are here to serve every Kenyan Citizen</p>
					<ul>
